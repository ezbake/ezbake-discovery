...
namespace java     ezbake.discovery.stethoscope.thrift
namespace cpp      ezbake.discovery.stethoscope.thrift
namespace py       ezbake.discovery.stethoscope.thrift
namespace js       ezbake.discovery.stethoscope.thrift
...
service StethoscopeService extends ezbakeBaseService.EzBakeBaseService
{
    /**
